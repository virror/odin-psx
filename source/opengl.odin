...
texture_create15 :: proc(w: i32, h: i32, vram: ^u16) -> u32 {
    texture: u32
...
texture_create24 :: proc(w: i32, h: i32, vram: ^u32) -> u32 {
    texture: u32
    gl.GenTextures(1, &texture)
    gl.BindTexture(gl.TEXTURE_2D, texture)
    ...
    gl.TexParameteri(gl.TEXTURE_2D, gl.TEXTURE_MIN_FILTER, gl.LINEAR)
    gl.TexParameteri(gl.TEXTURE_2D, gl.TEXTURE_MAG_FILTER, gl.NEAREST)
    gl.PixelStorei(gl.UNPACK_ROW_LENGTH, 682)
    gl.TexImage2D(gl.TEXTURE_2D, 0, gl.RGB, w, h, 0, gl.RGBA, gl.UNSIGNED_INT_8_8_8_8_REV, vram)
